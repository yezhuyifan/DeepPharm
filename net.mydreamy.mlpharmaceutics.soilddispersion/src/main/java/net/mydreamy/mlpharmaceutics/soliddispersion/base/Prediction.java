	...
	public static void prediction(String problem, String dataset, int size, String model, boolean print) {
		  ...
		  RecordReader recordReadertest = new CSVRecordReader(1,",");
	        ...
	        switch (problem) {
	        	...
	        	case "SD":    iteratortest = new RecordReaderDataSetIterator(recordReadertest, size, 15, 16, true); break; 
	        	case "SD-Single":    iteratortest = new RecordReaderDataSetIterator(recordReadertest, size, 15, 2); break; 
	        ...
	        switch (problem) {
	        	...
	        	case "OFDT":      EvaluationMCloud.AccuracyMAE(lablesTest, PredictionTest, 0.10); break;
	        	case "OFDF":  	  EvaluationMCloud.AccuracyMAE(lablesTest, PredictionTest, 0.10);	 break;
	        	case "SD":		  EvaluationMCloud.Accuracy3and6(lablesTest, PredictionTest); break;
	        	case "SD-Single": EvaluationMCloud.AccuracyF1(lablesTest, PredictionTest, new Evaluation(2)); break;
	        }
