...
allX <- read.csv("~/Desktop/PharmaceuticsData/trunk/SD/2016122remainingdata.csv")
extra<- read.csv("~/Desktop/PharmaceuticsData/trunk/SD/20161222finaltestdata.csv")
...
SelectedIndex <- maxDissim(initalSet, RemainingSet, n = 10, obj = minDiss, alpha = 2)
...
write.csv(FinalTestingSet, "~/Desktop/PharmaceuticsData/trunk/SD/testingset.csv", row.names = FALSE)
write.csv(FinalTrainingSet, "~/Desktop/PharmaceuticsData/trunk/SD/trainingset.csv", row.names = FALSE)
write.csv(UnScaledFinalTestingSet, "~/Desktop/PharmaceuticsData/trunk/SD/testingset(readyforcheck).csv", row.names = FALSE)
write.csv(UnScaledFinalTrainingSet, "~/Desktop/PharmaceuticsData/trunk/SD/trainingset(readyforcheck).csv", row.names = FALSE)
write.csv(scaledextradata, "~/Desktop/PharmaceuticsData/trunk/SD/extrascaledtestset.csv", row.names = FALSE)
