...
allX<- read.csv("/Users/yylonly/Desktop/PharmaceuticsData/trunk/OFDF/Remaining data 2017.1.3.csv")
extra<- read.csv("/Users/yylonly/Desktop/PharmaceuticsData/trunk/OFDF/Final testing data 2017.1.3.csv")
#allX<- read.csv("/Users/yylonly/Desktop/PharmaceuticsData/OFDF/Remaining data 2016.12.22.csv")
#extra<- read.csv("/Users/yylonly/Desktop/PharmaceuticsData/OFDF/Final testing data 2016.12.22.csv")
...
SelectedIndex <- maxDissim(initalSet, RemainingSet, n = 10, obj = minDiss)
...
write.csv(FinalTestingSet, "~/Desktop/PharmaceuticsData/trunk/OFDF/testingset.csv", row.names = FALSE)
write.csv(FinalTrainingSet, "~/Desktop/PharmaceuticsData/trunk/OFDF/trainingset.csv", row.names = FALSE)
write.csv(UnScaledFinalTestingSet, "~/Desktop/PharmaceuticsData/trunk/OFDF/testingset(readyforcheck).csv", row.names = FALSE)
write.csv(UnScaledFinalTrainingSet, "~/Desktop/PharmaceuticsData/trunk/OFDF/trainingset(readyforcheck).csv", row.names = FALSE)
write.csv(scaledextradata, "~/Desktop/PharmaceuticsData/trunk/OFDF/extrascaledtestset.csv", row.names = FALSE)
