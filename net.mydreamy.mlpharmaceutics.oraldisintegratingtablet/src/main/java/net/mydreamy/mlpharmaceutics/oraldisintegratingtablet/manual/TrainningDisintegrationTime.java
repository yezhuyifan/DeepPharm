...
//        .allowCrossDeviceAccess(true);
        ...
        try {
        	recordReadertrain.initialize(new FileSplit(new ClassPathResource("manual/trainsetapiparams.csv").getFile()));
...
//        log.info("training set:" + trainningData.getLabels().toString());
        ...
        try {
        	recordReadertest.initialize(new FileSplit(new ClassPathResource("manual/testsetapiparams.csv").getFile()));
		} catch (FileNotFoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (IOException e) {
