...
public class TranningSolidDispersion {
	public static Logger log = LoggerFactory.getLogger(TranningSolidDispersion.class);
...
//                        .build())
  ...
  //      terminationconditions.add(new ScoreImprovementEpochTerminationCondition(10, 1E-10));
        ...
        terminationconditions.add(new MaxEpochsTerminationCondition(4201));
