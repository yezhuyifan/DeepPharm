...
allX<- read.csv("/Users/yylonly/Desktop/PharmaceuticsData/OFDF/Remaining data 2017.1.3.csv")
extra<- read.csv("/Users/yylonly/Desktop/PharmaceuticsData/OFDF/Final testing data 2017.1.3.csv")
...
write.csv(FinalTestingSet, "~/Desktop/PharmaceuticsData/OFDF/testingset.csv", row.names = FALSE)
write.csv(FinalTrainingSet, "~/Desktop/PharmaceuticsData/OFDF/trainingset.csv", row.names = FALSE)
write.csv(UnScaledFinalTestingSet, "~/Desktop/PharmaceuticsData/OFDF/testingset(readyforcheck).csv", row.names = FALSE)
write.csv(UnScaledFinalTrainingSet, "~/Desktop/PharmaceuticsData/OFDF/trainingset(readyforcheck).csv", row.names = FALSE)
write.csv(scaledextradata, "~/Desktop/PharmaceuticsData/OFDF/extrascaledtestset.csv", row.names = FALSE)
