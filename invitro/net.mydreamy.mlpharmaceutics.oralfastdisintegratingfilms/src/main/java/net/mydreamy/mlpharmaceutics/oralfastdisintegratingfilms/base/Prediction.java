package net.mydreamy.mlpharmaceutics.oralfastdisintegratingfilms.base;
	...
	public static void prediction(String problem, String dataset, int size, String model, boolean print) {
		  ...
		  RecordReader recordReadertest = new CSVRecordReader(1,",");
	        ...
	        switch (problem) {
	        	...
	        	case "OFDF-final":  iteratortest = new RecordReaderDataSetIterator(recordReadertest, size, 18, 18, true);  break;
	        	case "OFDF-final-craft":  iteratortest = new RecordReaderDataSetIterator(recordReadertest, size, 18+6, 18+6, true);  break;
	        ...
	        switch (problem) {
	        	...
	        	case "OFDF-final":  Evaluation.AccuracyMAE(lablesTest, PredictionTest, 0.10); break;
	        	case "OFDF-final-craft":  Evaluation.AccuracyMAE(lablesTest, PredictionTest, 0.10); break;
	        	case "OFDF":  Evaluation.AccuracyR(lablesTest, PredictionTest, new RegressionEvaluation(1));  break;
	        	case "SD": break;
	        }
